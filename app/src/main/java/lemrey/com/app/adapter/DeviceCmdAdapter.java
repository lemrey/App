 ...
 */
public class DeviceCmdAdapter extends ArrayAdapter<Command> {

	private final List<Command> mFeatures;
	private final LayoutInflater mLayoutInflater;

	public DeviceCmdAdapter(Context context, int resource, List<Command> features) {
